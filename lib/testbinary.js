...
function testbinary(gyp, argv, callback) {
    ...
    try {
      ...
      console.log('this is it reqPath:', req_path);

      for (var i = 0; i < targets.length; i++) {
        console.log('Trying to require binary:', module_path + '/' + targets[i] + '.node');
        module = require(path.join(req_path, 'lib', platform, targets[i]));
      }
